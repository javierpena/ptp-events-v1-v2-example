...
func main() {
    ...
    log.Infof("Waiting for 30 seconds before subscribing. In a real deployment, you should check for the publisher and sidecar container health instead.")
...
func createSubscription(resourceAddress string) (sub pubsub.PubSub, err error) {
  ...
  sub = v1pubsub.NewPubSub(endpointURL, resourceAddress, "1.0")
  var subB []byte
